...
import org.jeecg.modules.system.util.AesEncryptUtil;
...
public class LoginController {
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel){
		...
		String passwords= sysLoginModel.getPassword();
		String password = AesEncryptUtil.aesDecrypt(passwords);
	...
	public Result<JSONObject> mPhoneLogin(@RequestBody SysLoginModel sysLoginModel) throws Exception {
		Result<JSONObject> result = new Result<JSONObject>();
