...
public class SysDepartServiceImpl extends ServiceImpl<SysDepartMapper, SysDepart> implements ISysDepartService {
	...
	@Override
	public List<SysDepartTreeModel> sysDepartTreeModelList(String departIds) {
		return  sysDepartMapper.sysDepartTreeModelList(departIds);
	}

	@Override
	public List<SysDepartTreeModel> departTreeList() {
		return sysDepartMapper.departTreeList();
	}

	@Override
	public List<SysDepart> departList() {
		return sysDepartMapper.departList();
	}
